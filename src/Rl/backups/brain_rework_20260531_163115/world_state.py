def choose_world_mode(game_state, sensory_state=None):
    ...
    # Do not classify based on distance from spawn.
    # In Doom, being far from spawn can mean the agent is making progress.
    ...
    if situation in ["stuck_or_looping", "spawn_wall_zone", "front_blocked", "secret_side_area"]:
        return "unstuck"
